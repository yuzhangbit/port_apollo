...
#include "integration_tests/planning_test_base.h"
...
void PlanningTestBase::SetUpTestCase() {
  FLAGS_planning_config_file = "conf/planning_config.pb.txt";
  FLAGS_planning_adapter_config_filename =
      "testdata/conf/adapter.conf";
  FLAGS_smoother_config_filename =
      "conf/qp_spline_smoother_config.pb.txt";
  FLAGS_map_dir = "testdata";
